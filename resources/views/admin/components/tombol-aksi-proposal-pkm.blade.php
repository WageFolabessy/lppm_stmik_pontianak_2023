<div class="d-flex justify-content-center align-items-center">
    ...
    <a href="#" id="tombol-hapus" class="btn btn-danger btn-icon-split mb-4 mr-2"
        title="Hapus" data-id="{{ $data->id }}">
        <span class="icon text-white-50">
            <i class="fas fa-trash"></i>
        </span>
    </a>
    <a href="{{ route('admin.toWord', $data->id) }}" id="tombol-word" class="btn btn-primary btn-icon-split mb-4"
